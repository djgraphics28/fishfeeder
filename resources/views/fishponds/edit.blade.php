    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">Edit Fishpond</div>

                        <div class="card-body">
                            <form action="{{ route('fishponds.update', $fishpond->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description"
                                        class="form-control summernote @error('description') is-invalid @enderror">{{ old('description', $fishpond->description) }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <select name="device" id="device"
                                        ...
                                        @foreach ($devices as $device)
                                            <option value="{{ $device->id }}"
                                                ...
                                                {{ $fishpond->device_id == $device->id ? 'selected' : '' }}>
                                                {{ $device->code }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="modal-body">
                            <img src="${imgSrc}" class="img-fluid">
                                ...
                                <div class="form-group">
                                    ...
                                    @enderror
                                    <div class="mt-3">
                                        <img id="logo-preview" src="{{ $fishpond->getFirstMediaUrl('fishpond-image') }}"
                                            alt="Fishpond Image Preview"
                                            class="img-thumbnail {{ $fishpond->getFirstMediaUrl('fishpond-image') ? '' : 'd-none' }}"
                                            style="max-height: 200px;">
                                    </div>
                                </div>

                                <button type="submit" class="btn btn-primary">Update Fishpond</button>
